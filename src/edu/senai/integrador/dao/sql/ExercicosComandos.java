...
public class ExercicosComandos {
	Configuracoes config = new Configuracoes();
	Properties prop = config.carrega(false);
	String[] tags = LeXml.getTag("exerComandos", "/bancoConfiguracoes.xml");
	
	public final String INSERT	= (tags[0]);
	public final String SELECT	= (tags[1]);
	public final String UPDATE	= (tags[2]);
	public final String DELETE	= (tags[3]);
